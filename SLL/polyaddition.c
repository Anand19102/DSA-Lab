...
struct Node *insertNode(struct Node *head, int coeff, int exp) {
    ...
    return head;
}// whatever parameter is passed, the same pointer is returned after insertion (head pointer of the linked list)
//usage is like head = insertNode(head, coeff, exp); , p1 = insertNode(p1, coeff, exp);
