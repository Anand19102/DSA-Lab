// Polynomial Multiplication using SLL
//read docs
#include <stdio.h>
#include <stdlib.h>
...
//for stack, queue, priority queue etc where global pointers like front, rear, top are used,
//we can create the push, pop, enqueue, dequeue functions etc without any return type (void) as the global pointers will be modified directly
//no need of special createNode functions for the above cases
//but for polynomial addition, multiplication etc where multiple linked lists are involved, we need to have functions returning the head pointer of the modified linked list